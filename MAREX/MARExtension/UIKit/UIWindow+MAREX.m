...
- (UIImage * _Nonnull)touchImage {
    ...
    if ([[UIScreen mainScreen] scale] == 2) {
        return [image imageByResizeToSize:CGSizeMake((image.size.width / 5) * 3, (image.size.width / 5) * 3)];
//        return [image imageByScalingProportionallyToSize:CGSizeMake((image.size.width / 5) * 3, (image.size.width / 5) * 3)];
    } else {
        return [image imageByResizeToSize:CGSizeMake((image.size.width / 3) * 2, (image.size.width / 3) * 2)];
