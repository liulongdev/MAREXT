...
#define MARModelSynthCoderAndHash \
- (void)encodeWithCoder:(NSCoder *)aCoder { [self mar_modelEncodeWithCoder:aCoder]; } \
- (id)initWithCoder:(NSCoder *)aDecoder { return [self mar_modelInitWithCoder:aDecoder]; } \
- (id)copyWithZone:(NSZone *)zone { return [self mar_modelCopy]; } \
 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `MARModel` protocol for custom methods.
 ...
 ********************** json convertor *********************
 ...
 @end
 @implementation MARBook
 @end
 
 int main() {
 // create model from json
 MARBook *book = [MARBook modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
...
/**
 ...
 `NSString` -> SEL, Class.
 */
+ (nullable instancetype)mar_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)mar_modelToJSONObject;
 ...
 */
- (nullable NSData *)mar_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)mar_modelToJSONString;
 ...
 */
+ (nullable NSArray *)mar_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (MARModel)
 ...
 */
+ (nullable NSDictionary *)mar_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<MARModelDelegate>' to your class header.
 */
@protocol MARModelDelegate <NSObject>
@optional
...
/**
 ...
 @implementation MARBook
 + (NSDictionary *)mar_modelCustomPropertyMapper {
 return @{@"name"  : @"n",
 @"page"  : @"p",
 @"desc"  : @"ext.desc",
 ...
 */
+ (nullable NSDictionary<NSString *, id> *)mar_modelCustomPropertyMapper;
...
/**
 ...
 @implementation MARAttributes
 + (NSDictionary *)mar_modelContainerPropertyGenericClass {
 return @{@"shadows" : [MARShadow class],
 @"borders" : MARBorder.class,
 @"attachments" : @"MARAttachment" };
 }
 @end
 
 @return A class mapper.
 */
+ (nullable NSDictionary<NSString *, id> *)mar_modelContainerPropertyGenericClass;
...
/**
 ...
 + (Class)mar_modelCustomClassForDictionary:(NSDictionary*)dictionary {
 if (dictionary[@"radius"] != nil) {
 return [MARCircle class];
 } else if (dictionary[@"width"] != nil) {
 return [MARRectangle class];
 } else if (dictionary[@"y2"] != nil) {
 return [MARLine class];
 } else {
 return [self class];
 }
 }
 ...
 */
+ (nullable Class)mar_modelCustomClassForDictionary:(NSDictionary *)dictionary;
 ...
 */
+ (nullable NSArray<NSString *> *)mar_modelPropertyBlacklist;
...
/**
 ...
 @return An array of property's name.
 */
+ (nullable NSArray<NSString *> *)mar_modelPropertyWhitelist;

/**
 This method's behavior is similar to `- (BOOL)mar_modelCustomTransformFromDictionary:(NSDictionary *)dic;`,
 ...
 */
- (NSDictionary *)mar_modelCustomWillTransformFromDictionary:(NSDictionary *)dic;
 ...
 */
- (BOOL)mar_modelCustomTransformFromDictionary:(NSDictionary *)dic;
...
/**
 ...
 @return Returns YES if the model is valid, or NO to ignore this model.
 */
- (BOOL)mar_modelCustomTransformToDictionary:(NSMutableDictionary *)dic;
